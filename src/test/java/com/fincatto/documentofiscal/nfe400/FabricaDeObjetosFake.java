...
public class FabricaDeObjetosFake {
    ...
    public static NFNotaInfoItemProdutoGrupoCreditoPresumido getNFNotaInfoItemProdutoGrupoCreditoPresumido() {
        NFNotaInfoItemProdutoGrupoCreditoPresumido mock = new NFNotaInfoItemProdutoGrupoCreditoPresumido();
        mock.setCodigoBeneficioFiscalCreditoPresumido("DF020111");
        mock.setPercentualCreditoPresumido(new BigDecimal("65.12"));
