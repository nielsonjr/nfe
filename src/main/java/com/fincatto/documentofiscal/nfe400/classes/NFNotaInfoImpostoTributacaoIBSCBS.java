...
public enum NFNotaInfoImpostoTributacaoIBSCBS {
	...
	CST_515("515", "Diferimento com redu\\u00e7\\u00e3o de al\\u00edquota", UM, ZERO, UM, UM, ZERO, SIM, NAO, NAO,
			NAO, NAO, NAO, NAO, NAO, SIM),
    ...
    CST_810("810", "Ajuste de IBS na ZFM",
    		 ZERO, ZERO, ZERO, ZERO, ZERO, SIM, NAO, NAO, NAO, NAO, NAO, NAO, NAO, NAO),
    
    CST_811("811", "Ajustes",
   		 ZERO, ZERO, ZERO, ZERO, ZERO, SIM, NAO, NAO, NAO, NAO, NAO, NAO, NAO, SIM),
